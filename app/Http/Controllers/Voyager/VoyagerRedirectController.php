...
class VoyagerRedirectController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if(isset($request->redirect_to)&&$request->redirect_to!=''){
            $redirect=redirect($request->redirect_to);
        }
