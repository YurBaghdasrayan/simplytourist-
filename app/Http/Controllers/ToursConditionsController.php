...
use App\Http\Requests\CreateToursConditionsRequest;
use App\Http\Requests\UpdateToursConditionsRequest;
use App\Models\ToursConditions;
use App\Repositories\ToursConditionsRepository;
use App\Http\Controllers\AppBaseController;
use Illuminate\Http\Request;
use Flash;
use Response;

class ToursConditionsController extends AppBaseController
{
    /** @var  ToursConditionsRepository */
    private $toursConditionsRepository;
    private static $slug = 'tours-conditions';

    public function __construct(ToursConditionsRepository $toursConditionsRepo)
    {
        $this->toursConditionsRepository = $toursConditionsRepo;
    }
...
//        $query=ToursConditions::select('*');
//        $dataTypeContent = self::getData(self::$slug, $request, $query);
//        $browserable_rows = self::getFields(self::$slug, $this);
//
//        return view('tours_conditions.index')
//            ->with(['toursConditions'=>$dataTypeContent,'rows'=>$browserable_rows]);
    }
