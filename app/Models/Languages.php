...
{
    //protected $primaryKey="language_iso";
    use HasFactory;
    ...
    public static function getCountry($country_iso){
        $countries=self::getCountries();
        if($country_iso)
            return $countries[strtoupper($country_iso)];
        else
            return '';
    }
    ...
    public static function getLang($language_iso){
        switch ($language_iso){
            case 'ru':
                return 'Русский';
                break;
