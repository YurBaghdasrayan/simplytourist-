    ...
    <div class="content px-3" id="app">
        @push('breadcrumbs')
            <div class="d-flex breadcrumbs">
                <span class="breadcrumb-inactive mr-2">{{__('Usergroups')}}</span>/<span class="ml-2">{{$group->usergroup_name}}</span>
            </div>
        @endpush
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <span class="d-flex pr-2">
                        <a href="/usergroup/{{$usergroup_id}}" class="btn btn-secondary">
        ...
        <div class="tab-content" id="custom-content-below-tabContent">
            <div class="card-body p-0">
                <form action="/invitations/groups" onsubmit="return false;" method="POST" id="send-invitation">
                    @csrf
                    ...
                    <label class="form-check-label mt-2"> {{__('Notify group members')}}</label>
            ...
            @include('usergroup_invitations.table_invite')
