...
@section('content')
    ...
    <div class="content px-3">
        ...
        <form id="add_tour" method="post" action="{{route('usergroups.update',$data[0]['id'])}}" onsubmit="return false;" enctype="multipart/form-data">
            @method('put')
            @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="usergroup_name" placeholder="{{__('Name of usergroup')}}"
                                   required="required" value="{{$data[0]['usergroup_name']}}"><br/>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select name="language_iso" class="form-control">
                                <option value="ru" @if($data[0]['language_iso']=='ru') selected="selected"@endif>Русский</option>
                                <option value="en" @if($data[0]['language_iso']=='en') selected="selected"@endif>English</option>
                                <option value="de" @if($data[0]['language_iso']=='de') selected="selected"@endif>Deutsch</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            ...
                            @include('layouts.partials.country',['country_name'=>'country_iso','selected'=>$data[0]['country_iso']])
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="usergroup_privat" id="" class="form-control" required="required">
                                ...
                                <option value="0" @if($data[0]['usergroup_privat']==0)selected="selected"@endif>{{__('Public')}}</option>
                                <option value="1" @if($data[0]['usergroup_privat']==1)selected="selected"@endif>{{__('Private')}}</option>
                            </select>
                        </div>
                        <div class="col-md-12">
